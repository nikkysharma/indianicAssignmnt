...
public class FancyDialog {
    ...
    private FancyDialogListener positiveListener,negativeListener;
    ...
    public static class Builder{
        ...
        public Builder OnPositiveClicked(FancyDialogListener positiveListener){
            this.positiveListener=positiveListener;
            return this;
        }

        //set Negative Listener
        public Builder OnNegativeClicked(FancyDialogListener negativeListener){
        ...
        public FancyDialog build(){
            ...
            dialog.setContentView(R.layout.fancy_dialog);
